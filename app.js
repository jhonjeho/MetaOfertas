...
function showPWAInstallPrompt() {
    // Agregar pequeño delay para asegurar DOM listo
    setTimeout(() => {
        ...
        card.style.cssText = `
            background: linear-gradient(135deg, #052b19 0%, #021a0e 100%);
        ...
        card.innerHTML = `
            <div style="margin-bottom: 1.5rem;">
                <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="margin: 0 auto; color: #22c55e;">
                    <polyline points="21 15 16 10 5 21"></polyline>
                    <polyline points="21 15 26 10 21 5"></polyline>
                    <path d="M3 7v13a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V7"></path>
                </svg>
            </div>
            <h2 style="font-size: 1.3rem; font-weight: 800; color: #f0fdf4; margin-bottom: 0.75rem;">
                Descargar MetaOfertas
            </h2>
            <p style="font-size: 0.9rem; color: #c7d2ca; margin-bottom: 2rem; line-height: 1.5;">
                Accede a tus ofertas favoritas directamente desde la pantalla de inicio.
            </p>
        ...
        console.log('[PWA] Modal de instalación mostrado');
    }, 500);
}
